 ...
 *
 * @author a2h
 * @copyright Copyright (c) 2009-2010 a2h
 */
...
(function() {
	...
	tinymce.create('tinymce.plugins.MediaSpongePlugin', {
		...
		init : function(ed, url) {
			...
			ed.addCommand('mceMediaSponge', function() {
				ed.windowManager.open({
					file : url + '/dialog.php',
					width : 480 + parseInt(ed.getLang('mediasponge.delta_width', 0)),
					height : 256 + parseInt(ed.getLang('mediasponge.delta_height', 0)),
					inline : 1
				}, {
		...
		getInfo : function() {
			return {
				longname : 'mintypublish TinyMCE Media Inserter',
				author : 'a2h',
